...
import com.example.appmucsic.Activity.DanhsachtheloaitheochudeActivity;
...
public class DanhsachtatcachudeAdapter extends RecyclerView.Adapter<DanhsachtatcachudeAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.with(context).load(APIService.getchude+chuDe.getHinhChuDe()).into(holder.imgchude);
    }
